const RecommendationProcessorFactory = require("../processor/RecommendationProcessorFactory.js");
...
class SystemMessage extends BaseMessage {
  ...
  async saveSystemMessage() {
    ...
    const processor = RecommendationProcessorFactory.getRecommendationProcessor(this.context, null, this.groupid);
