...
const orientationContext = (user, conversation, human_message) => {
    ...
    return new Promise((resolve, reject) => {
        let context = `
                        Sen, ürün ve hizmet önerisi için geliştirilmiş bir LLM asistanısın. Görevin, kullanıcının mesajlarından bağlamı analiz edip uygun yapıda bir JSON çıktısı üretmek.
                        Kurallar:
                        1. Kullanıcının isteği netse → "uncertainty_level: low", "action: recommendation"
                        2. Belirsizse → "uncertainty_level: high", "action: question" ve açıklayıcı sorular üret.
                        3. Geçmiş mesajlar varsa, öncelikli olarak onları dikkate al.
                        4. “Artık öneri yapabilirsin” gibi bir ifade varsa, geçmiş bağlama göre öneri yap.
...
module.exports = async (user, conversationid, human_message) => {
...
/**
 * Sen bir öneri motoru için geliştirilmiş uzman bir LLM asistanısın. 
